    ...
    <section className="flex h-[400px]">
      <div>
        <div
          ...
          aria-hidden="true"
        >
          <ColorInspect>An interactive design tool</ColorInspect>
        </div>
        ...
        <h1 className="col-start-1 row-start-2 mt-4 max-w-[36rem] text-4xl font-extrabold tracking-tight text-foreground sm:text-7xl xl:max-w-[43.5rem]">
          <ColorInspect>Watch your </ColorInspect>{" "}
          <span className="bg-gradient-to-r from-primary to-destructive bg-clip-text text-transparent ">
            <ColorInspect>theme</ColorInspect>
          </span>
          <ColorInspect>come to life</ColorInspect>
        </h1>
